...
===== Request Parameters
include::{snippets}/processes/export-search/request-parameters.adoc[]

===== Sample Request
include::{snippets}/processes/export-search/http-request.adoc[]

===== Sample Response
include::{snippets}/processes/export-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/processes/export-search/curl-request.adoc[]
...
===== Path Parameters
include::{snippets}/processes/export-single-page/path-parameters.adoc[]

===== Request Parameters
include::{snippets}/processes/export-single-page/request-parameters.adoc[]

===== Sample Request
include::{snippets}/processes/export-single-page/http-request.adoc[]

===== CURL Sample
include::{snippets}/processes/export-single-page/curl-request.adoc[]
...
===== Request Parameters
include::{snippets}/processes/recently-updated-search/request-parameters.adoc[]

===== Response Fields
include::{snippets}/processes/recently-updated-search/response-fields.adoc[]

===== Sample Request
include::{snippets}/processes/recently-updated-search/http-request.adoc[]

===== Sample Response
include::{snippets}/processes/recently-updated-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/processes/recently-updated-search/curl-request.adoc[]
