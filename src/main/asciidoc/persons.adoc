...
===== Request Parameters
include::{snippets}/persons/export-search/request-parameters.adoc[]

===== Sample Request
include::{snippets}/persons/export-search/http-request.adoc[]

===== Sample Response
include::{snippets}/persons/export-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/persons/export-search/curl-request.adoc[]
...
===== Path Parameters
include::{snippets}/persons/export-single-page/path-parameters.adoc[]

===== Request Parameters
include::{snippets}/persons/export-single-page/request-parameters.adoc[]

===== Sample Request
include::{snippets}/persons/export-single-page/http-request.adoc[]

===== CURL Sample
include::{snippets}/persons/export-single-page/curl-request.adoc[]
...
===== Request Parameters
include::{snippets}/persons/recently-updated-search/request-parameters.adoc[]

===== Response Fields
include::{snippets}/persons/recently-updated-search/response-fields.adoc[]

===== Sample Request
include::{snippets}/persons/recently-updated-search/http-request.adoc[]

===== Sample Response
include::{snippets}/persons/recently-updated-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/persons/recently-updated-search/curl-request.adoc[]
