...
===== Request Parameters
include::{snippets}/organizations/export-search/request-parameters.adoc[]

===== Sample Request
include::{snippets}/organizations/export-search/http-request.adoc[]

===== Sample Response
include::{snippets}/organizations/export-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/organizations/export-search/curl-request.adoc[]
...
===== Path Parameters
include::{snippets}/organizations/export-single-page/path-parameters.adoc[]

===== Request Parameters
include::{snippets}/organizations/export-single-page/request-parameters.adoc[]

===== Sample Request
include::{snippets}/organizations/export-single-page/http-request.adoc[]

===== CURL Sample
include::{snippets}/organizations/export-single-page/curl-request.adoc[]
...
===== Request Parameters
include::{snippets}/organizations/recently-updated-search/request-parameters.adoc[]

===== Response Fields
include::{snippets}/organizations/recently-updated-search/response-fields.adoc[]

===== Sample Request
include::{snippets}/organizations/recently-updated-search/http-request.adoc[]

===== Sample Response
include::{snippets}/organizations/recently-updated-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/organizations/recently-updated-search/curl-request.adoc[]
