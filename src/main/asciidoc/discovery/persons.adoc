...
===== Request Parameters
include::../{snippets}/persons/search/faceted/request-parameters.adoc[]

===== Response Fields
include::../{snippets}/persons/search/faceted/response-fields.adoc[]

===== Sample Request
include::../{snippets}/persons/search/faceted/http-request.adoc[]

===== Sample Response
include::../{snippets}/persons/search/faceted/http-response.adoc[]

===== CURL Sample
include::../{snippets}/persons/search/faceted/curl-request.adoc[]
