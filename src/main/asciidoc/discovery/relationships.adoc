...
===== Request Parameters
include::../{snippets}/relationships/search/faceted/request-parameters.adoc[]

===== Response Fields
include::../{snippets}/relationships/search/faceted/response-fields.adoc[]

===== Sample Request
include::../{snippets}/relationships/search/faceted/http-request.adoc[]

===== Sample Response
include::../{snippets}/relationships/search/faceted/http-response.adoc[]

===== CURL Sample
include::../{snippets}/relationships/search/faceted/curl-request.adoc[]
...
===== Request Parameters
include::../{snippets}/relationships/search/recently-updated/request-parameters.adoc[]

===== Response Fields
include::../{snippets}/relationships/search/recently-updated/response-fields.adoc[]

===== Sample Request
include::../{snippets}/relationships/search/recently-updated/http-request.adoc[]

===== Sample Response
include::../{snippets}/relationships/search/recently-updated/http-response.adoc[]

===== CURL Sample
include::../{snippets}/relationships/search/recently-updated/curl-request.adoc[]
