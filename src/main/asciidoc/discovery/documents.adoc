...
===== Request Parameters
include::../{snippets}/documents/search/faceted/request-parameters.adoc[]

===== Response Fields
include::../{snippets}/documents/search/faceted/response-fields.adoc[]

===== Sample Request
include::../{snippets}/documents/search/faceted/http-request.adoc[]

===== Sample Response
include::../{snippets}/documents/search/faceted/http-response.adoc[]

===== CURL Sample
include::../{snippets}/documents/search/faceted/curl-request.adoc[]
