...
===== Request Parameters
include::{snippets}/relationships/export-search/request-parameters.adoc[]

===== Sample Request
include::{snippets}/relationships/export-search/http-request.adoc[]

===== Sample Response
include::{snippets}/relationships/export-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/relationships/export-search/curl-request.adoc[]
...
===== Path Parameters
include::{snippets}/relationships/export-single-page/path-parameters.adoc[]

===== Request Parameters
include::{snippets}/relationships/export-single-page/request-parameters.adoc[]

===== Sample Request
include::{snippets}/relationships/export-single-page/http-request.adoc[]

===== CURL Sample
include::{snippets}/relationships/export-single-page/curl-request.adoc[]
...
===== Request Parameters
include::{snippets}/relationships/recently-updated-search/request-parameters.adoc[]

===== Response Fields
include::{snippets}/relationships/recently-updated-search/response-fields.adoc[]

===== Sample Request
include::{snippets}/relationships/recently-updated-search/http-request.adoc[]

===== Sample Response
include::{snippets}/relationships/recently-updated-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/relationships/recently-updated-search/curl-request.adoc[]
