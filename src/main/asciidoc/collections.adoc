...
===== Request Parameters
include::{snippets}/collections/export-search/request-parameters.adoc[]

===== Sample Request
include::{snippets}/collections/export-search/http-request.adoc[]

===== Sample Response
include::{snippets}/collections/export-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/collections/export-search/curl-request.adoc[]
...
===== Path Parameters
include::{snippets}/collections/export-single-page/path-parameters.adoc[]

===== Request Parameters
include::{snippets}/collections/export-single-page/request-parameters.adoc[]

===== Sample Request
include::{snippets}/collections/export-single-page/http-request.adoc[]

===== CURL Sample
include::{snippets}/collections/export-single-page/curl-request.adoc[]
...
===== Request Parameters
include::{snippets}/collections/recently-updated-search/request-parameters.adoc[]

===== Response Fields
include::{snippets}/collections/recently-updated-search/response-fields.adoc[]

===== Sample Request
include::{snippets}/collections/recently-updated-search/http-request.adoc[]

===== Sample Response
include::{snippets}/collections/recently-updated-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/collections/recently-updated-search/curl-request.adoc[]
