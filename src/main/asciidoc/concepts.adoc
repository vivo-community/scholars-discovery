...
===== Request Parameters
include::{snippets}/concepts/export-search/request-parameters.adoc[]

===== Sample Request
include::{snippets}/concepts/export-search/http-request.adoc[]

===== Sample Response
include::{snippets}/concepts/export-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/concepts/export-search/curl-request.adoc[]
...
===== Path Parameters
include::{snippets}/concepts/export-single-page/path-parameters.adoc[]

===== Request Parameters
include::{snippets}/concepts/export-single-page/request-parameters.adoc[]

===== Sample Request
include::{snippets}/concepts/export-single-page/http-request.adoc[]

===== CURL Sample
include::{snippets}/concepts/export-single-page/curl-request.adoc[]
...
===== Request Parameters
include::{snippets}/concepts/recently-updated-search/request-parameters.adoc[]

===== Response Fields
include::{snippets}/concepts/recently-updated-search/response-fields.adoc[]

===== Sample Request
include::{snippets}/concepts/recently-updated-search/http-request.adoc[]

===== Sample Response
include::{snippets}/concepts/recently-updated-search/http-response.adoc[]

===== CURL Sample
include::{snippets}/concepts/recently-updated-search/curl-request.adoc[]
