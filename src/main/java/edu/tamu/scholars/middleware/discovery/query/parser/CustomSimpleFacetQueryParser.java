...
public class CustomSimpleFacetQueryParser extends QueryParserBase<AbstractQueryDecorator> {
    ...
    public SolrQuery doConstructSolrQuery(AbstractQueryDecorator queryDecorator, Class<?> domainType) {
        CustomSimpleFacetQuery query = (CustomSimpleFacetQuery) queryDecorator.getDecoratedQuery();
